...
class View
{
    ...
    public function getHeadView()
    {
        ...
        <head>
            ...
            <script type='text/javascript' src='js/searchAsynchronous.js'></script>
        </head>
        <?php
    }
                ...
                <div class="buscador">
                    <form>
                        <div class="container-search">
                            ...
                            <input id="busqueda" placeholder="Buscar..." type="text" onkeyup="ajaxCall(this.value, '<?php echo $this->usuario->getPermiso(); ?>')">
