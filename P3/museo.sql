...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2018 a las 14:00:42
...
INSERT INTO `comentario` (`id`, `id_obra`, `ip`, `usuario`, `correo`, `fecha`, `comentario`) VALUES
(1, 2, '209.85.227.147', 'Juan', 'juan@gmail.com', '2018-04-20 01:53:57', 'Cristiano Leyenda'),
(3, 2, '109.69.381.231', 'Luis', 'luis@gmail.com', '2018-04-20 01:55:09', 'Raul eterno 7'),
(6, 3, '::1', 'Asier', 'asier@gmail.com', '2018-04-20 12:34:58', 'Aupa Atletic'),
(7, 3, '::1', 'Antxon', 'antxo@hotmail.com', '2018-04-20 12:35:34', 'fuera Ziganda'),
(8, 1, '::1', 'Etxebarria', 'etche@outlook.com', '2018-04-20 12:36:34', 'Nos mantenemos en primera'),
(9, 1, '::1', 'Yeste', 'yeste@yahoo.com', '2018-04-20 12:37:07', 'Gran remontada del equipo'),
(12, 3, '::1', 'Luis', 'luis@gmail.com', '2018-04-23 09:48:27', 'Me gusta este equipo');
...
(41, NULL, '', 'img/user.png'),
(42, NULL, '', 'img/user1.png'),
(43, NULL, '', 'img/user2.png'),
...
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `obra_asignada` FOREIGN KEY (`id_obra`) REFERENCES `obra` (`id`);
